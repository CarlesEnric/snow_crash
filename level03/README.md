...
```bash
level03@SnowCrash:/tmp$ env
LC_PAPER=es_ES.UTF-8
LC_ADDRESS=es_ES.UTF-8
LC_MONETARY=es_ES.UTF-8
TERM=xterm-256color
SHELL=/bin/bash
SSH_CLIENT=192.168.122.1 59572 4242
LC_NUMERIC=es_ES.UTF-8
OLDPWD=/home/user/level03
SSH_TTY=/dev/pts/0
USER=level03
...
SHLVL=1
HOME=/home/user/level03
LOGNAME=level03
SSH_CONNECTION=192.168.122.1 59572 192.168.122.220 4242
...
_=/usr/bin/env
```
##### Concretament la línia del PATH
```bash
PATH=/tmp:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games
```
